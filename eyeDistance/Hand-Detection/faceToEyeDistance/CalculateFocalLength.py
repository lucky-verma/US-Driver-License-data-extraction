...
markerTemplate = find_marker(image)

# focalLength = (markerTemplate[1][0] * KNOWN_DISTANCE) / KNOWN_WIDTH
focalLength = (350 * KNOWN_DISTANCE) / KNOWN_WIDTH
...
inches = distance_to_camera(KNOWN_WIDTH, focalLength, 350)
